...
//                viewHolder.imageViewBackground.setImageDrawable('@DrawableRes/productskgirl');
                Glide.with(viewHolder.itemView)
                        .load("https://tinyurl.com/rn4gtqp")
...
//                viewHolder.textViewDescription.setText("This is slider item " + position);
                ...
                viewHolder.imageGifContainer.setVisibility(View.GONE);
                Glide.with(viewHolder.itemView)
                        .load(" https://tinyurl.com/t27g3wt")
                        .fitCenter()
                        .into(viewHolder.imageViewBackground);
                break;
            case 4:
//                viewHolder.textViewDescription.setText("This is slider item " + position);
                ...
                viewHolder.imageGifContainer.setVisibility(View.GONE);
            Glide.with(viewHolder.itemView)
                        .load("https://tinyurl.com/rg4df47")
                        .fitCenter()
                        .into(viewHolder.imageViewBackground);
